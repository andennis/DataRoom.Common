...
& $SqlPackageExe /a:Publish /sf:"..\Tests\Common.Repository.Dapper.DB\bin\$config\Common.Repository.DB.dacpac" /pr:"..\Tests\Common.Repository.Dapper.DB\Common.Repository.DB.publish.xml"