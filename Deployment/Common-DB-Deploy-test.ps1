...
& $SqlPackageExe /a:Publish /sf:"..\Tests\Common.Repository.DB\bin\$config\Common.Repository.DB.dacpac" /pr:"..\Tests\Common.Repository.DB\Common.Repository.DB.publish.xml"